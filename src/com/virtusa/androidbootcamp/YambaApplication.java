...
public class YambaApplication extends Application implements OnSharedPreferenceChangeListener{
	...
	public synchronized Twitter getTwitter() {
		if (t == null) {
			t = new Twitter(prefs.getString("PREF_USER", null), prefs.getString("PREF_PASSWORD", null));
			t.setAPIRootUrl(prefs.getString("PREF_SITE_URL", "http://yamba.marakana.com/api"));
		}
		return t;
	}
